...
/**
 * The source design tints backgrounds using a hex alpha suffix like "1A" (~10% opacity),
 * e.g. `${COLORS.primary}1A`. This is the direct Compose equivalent.
 */
fun Color.faded(alpha: Float = 0.10f): Color = this.copy(alpha = alpha)
