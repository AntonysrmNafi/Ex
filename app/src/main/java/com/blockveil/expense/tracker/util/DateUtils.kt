...
/** e.g. "July 2026". Matches getMonthLabel in the source design, but from a real YearMonth. */
fun monthLabel(yearMonth: java.time.YearMonth): String = yearMonth.format(MONTH_LABEL_FORMATTER)
